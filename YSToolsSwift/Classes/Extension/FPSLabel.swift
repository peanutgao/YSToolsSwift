...
//  SCDoctor
//
//  Created by Joseph Koh on 2019/5/26.
...
class FPSLabel: UILabel {
    ...
    // MARK: - Properties
    private static let kRect = CGRect(x: (UIApplication.shared.keyWindow?.bounds.size.width)! - 100.0,
                                      y: 50, width: 60, height: 20)
    ...
    @objc func pan(sender: UIPanGestureRecognizer) {
        ...
        println(sender.location(in: window!))
