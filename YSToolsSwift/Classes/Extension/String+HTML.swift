...
extension String {
    ...
    public func htmlAttributed(using font: UIFont, color: UIColor) -> NSAttributedString? {
        do {
    ...
    public func htmlAttributed(family: String?, size: CGFloat, color: UIColor) -> NSAttributedString? {
        do {
            let htmlCSSString = "<style>" +
                "html *" +
                "{" +
